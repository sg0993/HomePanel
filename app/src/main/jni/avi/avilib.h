...
JNIEXPORT jint JNICALL Java_com_android_AVIUtil_init(JNIEnv *, jclass,
 ...
 * Signature: ([BI)I
 */
JNIEXPORT jint JNICALL Java_com_android_AVIUtil_writeVideo(JNIEnv *,
														   jclass, jbyteArray, jint, jlong);

/*
 * Class:     com_android_AVIUtil
 * Method:    writeAudio
 * Signature: ([BI)I
 */
JNIEXPORT jint JNICALL Java_com_android_AVIUtil_writeAudio(JNIEnv *,
														   jclass, jbyteArray, jint);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_android_AVIUtil_close(JNIEnv *, jclass);