...
public class MainActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View pageView1 = inflater.inflate(R.layout.mainpage01,null);
        pageViews.add(pageView1);
        View pageView2 = inflater.inflate(R.layout.mainpage02,null);
        ...
        viewPics = (ViewGroup) findViewById(R.id.framelayout1);
